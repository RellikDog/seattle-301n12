...
function displayPics(){
  ...
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed thconstiable declaration from var to `const`.
  // the previous line of code included a variable that was scoped locally insoide of a code block with const and therefore wasn'tm able to be read by the console log.
...
function makeChart(){
  makeChartData();const ctx = document.getElementById('chartypants').getContext('2d');
